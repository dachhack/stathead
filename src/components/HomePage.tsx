  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        tab: 'trade-calc',
        blurb: 'Evaluate proposed trades using dynasty market values with projected 30/60/90-day deltas. The Trade Finisher reads your Sleeper league, a partner and the offer on the table, and proposes fair versions that fit both teams\' goals, picks included; Swap Meet puts those versions on a shared page where your partner marks the ones they would accept, counters, and leaves notes.',
      },
      {
