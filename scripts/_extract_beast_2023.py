...
Parses pdfs/.cache/the_beast_2023.text.txt into a JSON array of per-player
feature records (QB/RB/WR/TE only, per task spec) and writes
pdfs/.cache/the_beast_2023.d52f0eac.features.json.
"""
...
INPUT_PATH = "/Users/matthewporritt/stathead/pdfs/.cache/the_beast_2023.text.txt"
OUTPUT_PATH = "/Users/matthewporritt/stathead/pdfs/.cache/the_beast_2023.d52f0eac.features.json"
...
def parse(lines):
    ...
    for i, line in enumerate(lines):
        ...
        # Dedouble doubled-letter PDF artifacts (e.g. QQUUAARRTTEERRBBAACCKKSS)
        normalized = re.sub(r"([A-Z])\1", r"\1", stripped)
        if stripped in POSITION_HEADERS:
            position_by_line.append((i, POSITION_HEADERS[stripped]))
        elif normalized != stripped and normalized in POSITION_HEADERS:
            position_by_line.append((i, POSITION_HEADERS[normalized]))
