...
and whose features are:
  ...
  slow (from training-rows-cache-v44.json, joined by normalized name + pos):
...
TRAINING_CACHE_PATH = DATA_DIR / 'training-rows-cache-v44.json'
...
DROP_GLOBAL = {
    # Always 0 — key doesn't exist in training-rows-cache-v44.json. The
