...
30 tools spanning player and team data, including:
...
| Fantasy | StatHead blended dynasty values, `get_projections` (StatHead's in-house season PPG model + the Mike Clay "Consensus" benchmark), ADP (FFC / ESPN / Sleeper), `get_adp_with_results` (ADP vs actual finish), trending adds/drops |
